    ...
    items: [
      {
        ...
        imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ5nk7-GhnGTiApCURC5DckqXtv_0mzxEC59usc7m3_Dkoh1Wm0qOTWvAlN&s=10',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        content: 'นิเทศและสนับสนุนมาตรฐานระบบยา รพ.สต. ในเครือข่ายจังหวัดภูเก็ต, การเยี่ยมบ้านผู้ป่วยติดเตียง (Home Health Care) และการจัดการยาในชุมชน'
      },
      {
        id: 'struct_dis',
    ...
    items: [
      {
        ...
        description: 'รายการยาที่ได้รับการบรรจุในบัญชียาโรงพยาบาลวชิระภูเก็ต ฉบับปรับปรุงล่าสุด',
        content: 'รายการยาทั้งหมดที่ผ่านการอนุมัติจากคณะกรรมการเภสัชกรรมและการบำบัด (PTC) โรงพยาบาลวชิระภูเก็ต พร้อมข้อบ่งใช้ ขนาดยา และเงื่อนไขการสั่งใช้'
      },
      {
        id: 'di_tmt',
        title: 'รหัส TMT ยาโรงพยาบาลวชิระภูเก็ต',
        badge: 'TMT Code',
        description: 'รหัสยามาตรฐานไทย (Thai Medicines Terminology) ประจำโรงพยาบาลวชิระภูเก็ต',
      ...
      },
      {
        ...
        badge: 'รพ.สต.',
        description: 'รายการยาสำหรับโรงพยาบาลส่งเสริมสุขภาพตำบล (รพ.สต.) ในเครือข่ายจังหวัดภูเก็ต',
        content: 'รายการยาที่ได้รับอนุญาตให้สำรองและใช้ใน รพ.สต. เครือข่ายบริการสุขภาพจังหวัดภูเก็ต'
      },
      {
        id: 'di_form_r2',
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            title: 'คู่มือการใช้ยาในรพ.สต.จังหวัดภูเก็ต',
            badge: 'รพ.สต.ภูเก็ต',
            description: 'คู่มือแนวทางการใช้ยาสำหรับเจ้าหน้าที่สาธารณสุขใน รพ.สต. เครือข่าย',
            content: 'คู่มือการบริหารจัดการยา การให้คำแนะนำ และการส่งต่อผู้ป่วยที่มีปัญหาจากการใช้ยาใน รพ.สต. จังหวัดภูเก็ต'
          },
          {
            id: 'di_dis_service',
    ...
    items: [
      {
        ...
        description: 'นโยบายด้านยาและเวชภัณฑ์ โรงพยาบาลวชิระภูเก็ต',
    ...
    items: [
      {
        ...
        content: 'รวบรวมรายงานวิจัย โครงการศึกษา และบทคัดย่อผลงานวิชาการของเภสัชกรโรงพยาบาลวชิระภูเก็ต'
      },
      {
        id: 'acad_innovation',
